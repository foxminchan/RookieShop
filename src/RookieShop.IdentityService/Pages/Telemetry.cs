...
namespace RookieShop.IdentityService.Pages;
...
public static class Telemetry
{
    ...
    public static class Metrics
    {
        ...
        public static void GrantsRevoked(string? clientId)
            => _grantsRevokedCounter.Add(1, new KeyValuePair<string, object?>(Tags.Client, clientId));
        ...
        public static void UserLogout(string? idp)
            => _userLogoutCounter.Add(1, new KeyValuePair<string, object?>(Tags.Idp, idp));
