...
namespace RookieShop.IdentityService.Pages.ServerSideSessions;

public sealed class IndexModel(ISessionManagementService? sessionManagementService = null) : PageModel
{
